...
class Options(object):
    ...
    """
    def __init__(
            self, verbosity=None, inventory=None, listhosts=None, subset=None,
            module_paths=None, extra_vars=None,
...
class Runner(object):
    ...
    def __init__(
            self, hostnames, playbook, private_key_file, run_data,
            become_pass, verbosity=0):
